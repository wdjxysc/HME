...
{
    GlucoseAnalysisViewController *glucoseAnalysisViewController = [[GlucoseAnalysisViewController alloc]initWithNibName:@"GlucoseAnalysisViewController" bundle:nil];
    [self presentViewController:glucoseAnalysisViewController animated:NO completion:^{
        NSLog(@"跳转图表页面");
    }];
}
