...
@interface BloodPressMeasureViewController_iphone ()

@end

@implementation BloodPressMeasureViewController_iphone
...
{
    //适配4Inch屏幕
    NSString *nibName = @"BloodPressAnalysisViewController_iphone";
    if(iPhone5)
    {
        nibName = @"BloodPressAnalysisViewController_iphone_4Inch";
    }
    
    BloodPressAnalysisViewController_iphone *bloodPressAnalysisViewController_iphone = [[BloodPressAnalysisViewController_iphone alloc]initWithNibName:nibName bundle:nil];
    [self presentViewController:bloodPressAnalysisViewController_iphone animated:NO completion:^{
        NSLog(@"跳转图表页面");
    }];
}
