//
//  GlucoseAnalysisViewController_iphone.m
//  HME
//
...
#import "GlucoseDataCell_iphone.h"
#import "database.h"
...
@interface GlucoseAnalysisViewController_iphone ()

@end

@implementation GlucoseAnalysisViewController_iphone
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        GlucoseDataCell_iphone *cell = (GlucoseDataCell_iphone *)[tableView dequeueReusableCellWithIdentifier:CellTableIdentifier];
        
        if(cell == nil)
        {
            NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"GlucoseDataCell_iphone" owner:self options:nil];
            cell = [nib objectAtIndex:0];
        }
        NSUInteger row = [indexPath row];
