...
//        returncell = cell;
    ...
    {
        BloodPressDataCell *cell = (BloodPressDataCell *)[tableView dequeueReusableCellWithIdentifier:CellTableIdentifier];
        
        if(cell == nil)
        {
            NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"BloodPressDataCell" owner:self options:nil];
            cell = [nib objectAtIndex:0];
        }
        NSUInteger row = [indexPath row];
...
//        int y = rand();
    ...
    LineChartView *chartView = [[LineChartView alloc] initWithFrame:CGRectMake(430, 100, 500, 300)];
    chartView.yMin = 0;
    chartView.yMax = 300;
