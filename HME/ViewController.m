...
-(void)login
{
    ...
    if(b == true){ //登陆成功
        ...
        //适配4Inch屏幕
        NSString *nibName = @"ChooseItemViewController_iphone";
        if(iPhone5)
        {
            nibName = @"ChooseItemViewController_iphone_4Inch";
        }
        ChooseItemViewController_iphone *chooseItemViewController_iphone = [[ChooseItemViewController_iphone alloc]initWithNibName:nibName bundle:nil];
        [self presentViewController:chooseItemViewController_iphone animated:NO completion:^{//备注2
            NSLog(@"show InfoView!");
        }];
