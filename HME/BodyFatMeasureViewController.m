...
#import "BodyFatAnalysisViewController.h"
...
{
    BodyFatAnalysisViewController *bodyFatAnalysisViewController = [[BodyFatAnalysisViewController alloc]initWithNibName:@"BodyFatAnalysisViewController" bundle:nil];
    [self presentViewController:bodyFatAnalysisViewController animated:NO completion:^{
        NSLog(@"跳转图表页面");
    }];
}
